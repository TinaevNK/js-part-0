...
const getType = (value: any): DefaultType => typeof value;

const getTypesOfItems = (arr: any[]): DefaultType[] => arr.map(getType);
...
const getRealTypesOfItems = (arr: any[]): RealType[] => arr.map(getRealType);
